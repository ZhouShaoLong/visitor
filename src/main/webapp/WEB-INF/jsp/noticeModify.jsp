                    ...
                    <div class="contentarea">
                        <div class="row">
                            <div class="module_content contact_form">
                                <div id="fields">
                                    <form action="insertModify.do?id=${modify.notice_id}" method="post" role="form">
                                        <div class="row row20">
                                            <div class="col-sm-12"><input type="text" name="title" value="${modify.title}"
                                                                          placeholder="标题"/></div>
                                        </div>
                                        <textarea name="content">${modify.content}</textarea>
                                        有效时间至：<input type="date" name="endtime" value="${modify.endTime}">
                                        <input type="submit" value="提交修改" style="display: inline;float: right">
                                    </form>
                                </div>
                            </div>
                        </div>
