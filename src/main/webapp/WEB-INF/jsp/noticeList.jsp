                            ...
                            <div class="row">
                            	<div class="col-sm-12 module_cont pb20 animate" data-anim-type="fadeInLeft" data-anim-delay="300">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach items="${list}" var="notice" begin="${(page-1)*15}" end="${page*15-1}">
                                            <tr>
                                                ...
                                                <c:if test="${sessionScope.admin!=null}">
                                                <td><a href="<c:url value="/notice/delete.do?id="/>${notice.notice_id}" style="color: red">删除</a>&nbsp;&nbsp;<a href="<c:url value="/notice/modify.do?id="/>${notice.notice_id}">修改</a></td>
                                                </c:if>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="container" style="margin-right: 200px; float: right; width: auto;">
                                        <form class="form-inline" action="/notice/noticeList.do" role="form">
                                            <a href="/notice/noticeList.do?page=${page-1}">上一页</a>
                                            <a href="/notice/noticeList.do?page=${page+1}">下一页</a>
