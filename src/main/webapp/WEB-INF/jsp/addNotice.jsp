                    ...
                    <div class="contentarea">
                        <div class="row">
                            <div class="module_content contact_form">
                                <div id="fields" style="width: 98%">
                                    <form action="Publish.do" method="post" role="form">
                                        <div class="row row20">
                                            <div class="col-sm-12"><input type="text" name="title" value=""
                                                                          placeholder="标题"/></div>
                                        </div>
                                        <textarea name="content"></textarea>
                                        <input type="date" name="endtime">
                                        <input type="submit" value="提交" style="display: inline;float: right">
                                    </form>
                                </div>
                            </div>
                        </div>
