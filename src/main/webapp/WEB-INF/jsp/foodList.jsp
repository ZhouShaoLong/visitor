            ...
            <div class="fl-container">
                <div class="posts-block">
                    <div class="contentarea">
                        <div id="my_input" style="width: 200px;float: right;">
                            <form action="/food/search.do" method="post">
                                搜索城市：<input type="text" name="city" id="asd" placeholder="城市名">
                            </form>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 module_cont pb20 animate" data-anim-type="fadeInLeft"
                                 data-anim-delay="300">
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${foodList}" var="food">
                                        <tr>
                                                <%--<td><a href="<c:url value="/notice/detail.do?"/>id=${notice.notice_id}&admin_id=${notice.admin_id}">${notice.title}</a></td>--%>
                                            <td><a href="/food/detail.do?id=${food.id}">${food.name}</a></td>
                                            <td>${food.address}</td>
                                            <td>${food.tel}</td>
                                            <td>${food.adname}</td>
                                        </tr>
...
<div class="footer">
    <div class="container">
                    ...
                    <div class="sidepanel widget_text">
                        ...
                        <div class="footer_socials">
                            <ul>
                                ...
                                <li><a href="javascript:void(0);" class="soc_tweet"><i class="icon-twitter"></i></a>
                                </li>
                                <li><a href="javascript:void(0);" class="soc_google"><i
                                        class="icon-google-plus"></i></a></li>
                                <li><a href="javascript:void(0);" class="soc_dribbble"><i class="icon-dribbble"></i></a>
                                </li>
                                <li><a href="javascript:void(0);" class="soc_pinterest"><i
                        ...
                        <ul class="recent_posts">
                            <li class="with_img">
                                <div class="recent_posts_content">
                                    ...
                                    <div class="recent_posts_info">2017-7-22 / <a href="javascript:void(0);">2 days</a>
                                    </div>
                                </div>
                            </li>
                            <li class="with_img">
                                <div class="recent_posts_content">
                                    ...
                                    <div class="recent_posts_info">2017-7-23 / <a href="javascript:void(0);">2 day</a>
                                    </div>
                                </div>
                            </li>
                            <li class="with_img">
                                <div class="recent_posts_content">
                                    ...
                                    <div class="recent_posts_info">2017-7-25 / <a href="javascript:void(0);">1 day</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul class="recent_posts">
                            ...
                            <li class="with_img">
                                <div class="recent_posts_content">
                                    ...
                                    <div class="recent_posts_info">2017-7-23 / <a href="javascript:void(0);">2 days</a>
                                    </div>
                                </div>
                            </li>
                            <li class="with_img">
                                <div class="recent_posts_content">
                                    ...
                                    <div class="recent_posts_info">2017-7-24 / <a href="javascript:void(0);">1 day</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="footer_bottom">
            <div class="copyright">Copyright 2017. All Rights Reserved by Software Engineering College, Premium HTML
                Template.
            </div>
            <div class="clear"></div>
        </div>
...
<script>
    items_set = [
        {
            src: 'static/img/portfolio/370_300/10.jpg',
            zoom: 'static/img/portfolio/370_300/10.jpg',
        ...
        {
            src: 'static/img/portfolio/370_300/11.jpg',
            zoom: 'static/img/portfolio/370_300/11.jpg',
            url: 'portfolio_post_fullwidth.html',
            columnclass: 'col-sm-4',
        ...
        {
            src: 'static/img/portfolio/370_300/12.jpg',
            zoom: 'static/img/portfolio/370_300/12.jpg',
            url: 'portfolio_post_fullwidth.html',
            columnclass: 'col-sm-4',
