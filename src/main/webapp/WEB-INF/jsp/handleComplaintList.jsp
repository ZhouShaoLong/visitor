                            ...
                            <div class="row">
                            	<div class="col-sm-12 module_cont pb20 animate" data-anim-type="fadeInLeft" data-anim-delay="300">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach items="${list}" var="complaint"  begin="${page*15-15}" end="${page*15-1}">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${complaint.getCheckStatus()==0}">
                                                        <c:out value="否"/>
                                                    </c:if>
                                                    <c:if test="${complaint.getCheckStatus()==1}">
                                                        <c:out value="是"/>
                                                    </c:if>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="<c:url value="/complaint/check.do?checkStatus=1&complaint_id="/>${complaint.getId()}">通过</a>
                                                    &nbsp;&nbsp;
                                                    <a href="<c:url value="/complaint/check.do?checkStatus=0&complaint_id="/>${complaint.getId()}">不通过</a>
                                                </td>
                                                <td>
                                                    <a href="<c:url value="/complaint/toReplyInput.do?complaint_id="/>${complaint.getId()}">回复</a>
                                                    &nbsp;&nbsp;
                                                    <a href="<c:url value="/complaint/delete.do?complaint_id="/>${complaint.getId()}">删除</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="container" style="margin-right: 200px; float: right; width: auto;">
                                        <form class="form-inline" action="/complaint/toReply.do" role="form">
                                            <a href="/complaint/toReply.do?page=${page-1}">上一页</a>
                                            <a href="/complaint/toReply.do?page=${page+1}">下一页</a>
