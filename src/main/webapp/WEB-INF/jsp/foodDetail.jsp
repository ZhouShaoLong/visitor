            ...
            <div class="fl-container">
                <div class="posts-block">
                    <div class="contentarea">
                        <div class="row">
                            <div class="col-sm-8 module_cont pb20 animate" data-anim-type="fadeInLeft"
                                 data-anim-delay="300">
                                <p><b>店铺类型：</b>${detail.type}</p>
                                <p><b>营业时间：</b>${detail.open_time}</p>
                                <p><b>店铺地址：</b>${detail.address}</p>
                                <p><b>联系电话：</b>${detail.tel}</p>
                                <p><b>店铺简介：</b>${detail.intro}</p>
                                <p><b>店铺标签：</b>${detail.tag}</p>
                                <p><b>推荐菜单：</b>${detail.recommend}</p>

                            </div>
                            <div class="col-sm-4 module_cont contact_info pb40 animate" data-anim-type="fadeInRight"
                                 data-anim-delay="300">
                                <%--店铺位置--地图--%>
                                <iframe src="http://uri.amap.com/marker?position=${detail.location}&name=${detail.name}"
