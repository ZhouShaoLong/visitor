    	...
    	<div class="container">
            <div class="breadcrumbs">
                <div class="container">
                    ...
                    <h1 class="title-page">星级酒店查询功能</h1>
                </div>
            </div>
            <div class="modal-dialog">
                <form action="/hotel/search.do" method="post">
                    ...
                    星级:&emsp;&emsp;
                    <label><input name="star" type="radio" value="0" checked="checked"/>非星级&emsp;&emsp;</label>
                    <label><input name="star" type="radio" value="1" />一星&emsp;&emsp;</label>
                    <label><input name="star" type="radio" value="2" />二星&emsp;&emsp;</label>
                    <label><input name="star" type="radio" value="3" />三星&emsp;&emsp;</label>
                    <label><input name="star" type="radio" value="4" />四星&emsp;&emsp;</label>
                    <label><input name="star" type="radio" value="5" />五星&emsp;&emsp;</label>
                    <br></br>
                    价格:&emsp;&emsp;
                    <label><input name="price" type="radio" value="1" checked="checked"/>150以下&emsp;&emsp;</label>
                    <label><input name="price" type="radio" value="2" />150-300&emsp;&emsp;</label>
                    <label><input name="price" type="radio" value="3" />300-600&emsp;&emsp;</label>
                    <label><input name="price" type="radio" value="4" />600以上&emsp;&emsp;</label>
                    <br></br>
                入住: <input type="text" name="入住" />
                退房: <input type="text" name="退房" />
                            ...
                            <div class="row">
                            	<div class="col-sm-12 module_cont pb20 animate" data-anim-type="fadeInLeft" data-anim-delay="300">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach items="${list}" var="hotel" begin="${page*15-15}" end="${page*15-1}">
                                            <tr>
                                                <td>${hotel.getName()}</td>
                                                ...
                                                <c:if test="${sessionScope.admin!=null}">
                                                    <td><a href="/room/toRoomList.do?page=1&hotel_id=${hotel.getHotel_id()}">修改房间信息</a> </td>
                                                </c:if>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table><br/>
                                    <div class="container" style="margin-right: 200px; float: right; width: auto;">
                                        <form class="form-inline" action="/hotel/showAll.do" role="form">
                                            <a href="/hotel/showAll.do?page=${page-1}">上一页</a>
                                            <a href="/hotel/showAll.do?page=${page+1}">下一页</a>
                                            <input type="number" name="page" value="${page}">/${totalPage}页<input type="submit" value="跳到" class="btn btn-default">
                                        </form>
                                    </div>
                                </div>
                            </div>
