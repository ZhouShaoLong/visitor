                            ...
                            <div class="row">
                            	<div class="col-sm-12 module_cont pb20 animate" data-anim-type="fadeInLeft" data-anim-delay="300">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach items="${list}" var="performance" begin="${page*15-15}" end="${page*15-1}">
                                            <tr>
                                                <td>${performance.getTitle()}</td>
                                                <td>${performance.getType()}</td>
                                                <td>${performance.getGroupName()}</td>
                                                <td>${performance.getStartTime()}</td>
                                                <td>${performance.getEndTime()}</td>
                                                <td>${performance.getPrice()}</td>
                                            </tr>
                                            <tr><td></td><td colspan="5">${performance.getIntro()}</td></tr>
                                        </c:forEach>
                                        </tbody>
                                    </table><br/>
                                    <div class="container" style="margin-right: 200px; float: right; width: auto;">
                                        <form class="form-inline" action="/performance/showAll.do" role="form">
                                            <a href="/performance/showAll.do?page=${page-1}">上一页</a>
                                            <a href="/performance/showAll.do?page=${page+1}">下一页</a>
