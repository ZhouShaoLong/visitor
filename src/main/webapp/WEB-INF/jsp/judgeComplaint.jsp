    	...
    	<div class="container">
        	<div class="page_title_block">
                ...
                <div class="page_descr">
                    <p>
                        投诉是为了让我们变得更好，评价告诉我们哪里处理的还不满意，我们会一直进步。
                    </p>
                </div>
            </div>
                            	...
                            	<div class="col-sm-9 module_cont pb20 animate" data-anim-type="fadeInLeft" data-anim-delay="300">
                                	<div class="module_content contact_form">
                                        ...
                                        <div id="fields">
                                            ...
                                            <hr size="2">
                                            <form action="<c:url value="/complaint/judge.do?complaint_id="/>${complaint.getId()}"  method="post" role="form">
                                            	<div class="row row20">
                                                    <fieldset class="starability-slot">
                                                        <input type="radio" id="rate5-2" name="star" value="5" />
                                                        <label for="rate5-2" title="非常满意">5 星</label>

                                                        <input type="radio" id="rate4-2" name="star" value="4" />
                                                        <label for="rate4-2" title="满意">4 星</label>

                                                        <input type="radio" id="rate3-2" name="star" value="3" />
                                                        <label for="rate3-2" title="一般">3 星</label>

                                                        <input type="radio" id="rate2-2" name="star" value="2" />
                                                        <label for="rate2-2" title="差">2 星</label>

                                                        <input type="radio" id="rate1-2" name="star" value="1" />
                                                        <label for="rate1-2" title="糟糕">1 星</label>
                                                    </fieldset>
                                                </div>                    
                                                <textarea name="judge">${complaint.getJudge()}</textarea><br/>
                                                    <input type="submit" value="评价" style="width: 200px;">
                                            </form> 
                                        </div>
                                    </div>                                
                                </div>
                            	<div class="col-sm-3 module_cont contact_info pb40 animate" data-anim-type="fadeInRight" data-anim-delay="300">
                                	<h3 class="mb20 mt_5">联系我们</h3>
                                    <p><span>电话:</span>85996 888</p>
                                    <p><span>地址:</span> 四川大学 软件学院</p>
                                    <p class="mb29"><span>电子邮箱:</span> <a href="mailto:menfer@foxmail.com">menfer@foxmail.ocm</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
