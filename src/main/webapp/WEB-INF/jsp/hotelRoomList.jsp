                            ...
                            <div class="row">
                            	<div class="col-sm-12 module_cont pb20 animate" data-anim-type="fadeInLeft" data-anim-delay="300">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <c:forEach items="${list}" var="room" begin="${page*15-15}" end="${page*15-1}">
                                            <tr>
                                                <form action="/room/editInfo.do" method="post">
                                                    <input type="hidden" name="hotel_id" value="${room.getHotel_id()}">
                                                    <input type="hidden" name="room_num" value="${room.getRoom_num()}">
                                                    <td>${room.getRoom_num()}</td>
                                                    <td><input type="text" value="${room.getPrice()}" name="price"></td>
                                                    <td>
                                                        <c:if test="${room.getOrderStatus()==0}">
                                                            <input type="radio" name="orderStatus" value="0" checked="checked">否
                                                            <input type="radio" name="orderStatus" value="1">是
                                                        </c:if>
                                                        <c:if test="${room.getOrderStatus()==1}">
                                                            <input type="radio" name="orderStatus" value="0">否
                                                            <input type="radio" name="orderStatus" value="1" checked="checked">是
                                                        </c:if>
                                                    </td>
                                                    <td><input type="date" value="${room.getStartTime()}" name="startTime">到&nbsp;<input type="date" value="${room.getEndTime()}" name="endTime"></td>
                                    ...
                                    <div class="container" style="margin-right: 200px; float: right; width: auto;">
                                        <form class="form-inline" action="/room/toRoomList.do" role="form">
                                            <input type="hidden" name="hotel_id" value="${hotel_id}">
                                            <a href="/room/toRoomList.do?page=${page-1}&hotel_id=${hotel_id}">上一页</a>
                                            <a href="/room/toRoomList.do?page=${page+1}&hotel_id=${hotel_id}">下一页</a>
